...
## Methodology
**Dataset**: We compiled 44,663 drug-relationship-target triplets from the Therapeutic Target Database, which are in “drug_relationship_target.csv”. URL to database: https://db.idrblab.net/ttd/ ![Sample Graph](graph.png).
